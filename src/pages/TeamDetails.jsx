        ...
        <section className="w-full flex gap-8 h-[85vh] flex-wrap">
          ...
          {modalOpened ? (
            <div className="w-72 h-80 rounded-lg bg-gray-200 mt-10 shadow-md p-5 flex flex-col items-center">
              <span
                className=" ml-auto cursor-pointer p-2 rounded-full hover:bg-gray-300"
                onClick={() => {
                  setModalOpened(false);
                }}
              >
                <IoMdClose className=" w-6 h-6 hover:opacity-60" />
              </span>
              ...
              <form onSubmit={addList} className="flex flex-col justify-center">
                ...
                />
                <button
                  className=" bg-dodger-blue-700 p-1 rounded-md font-medium text-white"
                  type="submit"
                >
                  Done
                </button>
            ...
            <div
              className="w-72 h-12 rounded-lg bg-gray-200 mt-10 shadow- flex items-center justify-center hover:scale-[0.99] hover:bg-gray-100 cursor-pointer"
              onClick={() => setModalOpened(true)}
            >
              <RiAddLine />
              <p className="font-medium "> Add new list</p>
            </div>
          )}
        </section>
      </div>
